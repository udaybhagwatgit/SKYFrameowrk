...
public class VerifyContents extends TestBase {
	
	// 7.	Again go to those messages and check if the contents are actually stored.
    ...
    public void verifyContents_test(Map<String, Object> testData, String browserName, String version, String os, String methodName) throws Exception {
